...
class M_uploadipp extends CI_Model {
...
function addHeader($data1, $data2, $data3) {
	...
	$this->db->insert('ipp_mobile_shopfloorheader', $data1);
	...
	$this->db->insert_batch('ipp_mobile_shopfloorlinesreject', $data2);


	for($i = 0; $i < count($data3); $i++) {
		$data3[$i]['hostHeadEntry'] = $docEntry_header;
	}
	$this->db->insert_batch('IPP_MOBILE_SHOPFLOORLINESCRITERIA', $data3);
